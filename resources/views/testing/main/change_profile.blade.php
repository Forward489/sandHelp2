...
@section('container')
    ...
    <div class="profile-card">
        <div class="profile-header text-center">
            ...
            {{-- GLENN INI KASI HREF KE PROFILE --}}
            @if (auth()->user()->profile_picture)
                <a href="{{ route('profile_page_trial') }}">
            ...
            <form action="{{ route('submit_edit') }}" method="post" id="demo-form" enctype="multipart/form-data">
                ...
                <div class="form-group ml-4 mt-4">
                    ...
                    @error('profile_picture')
                        <br>
                        <label for="profile_picture" style="color: red" class="inputLabel font-weight-bold">{{ $message }}</label>
                    @enderror

                    <br>
                    <label for="description" class="inputLabel">Description</label>
                    <textarea name="description" id="description" cols="30" maxlength="250" rows="4"
                        class="form-control  description" style="width:95%;">{{ auth()->user()->description }}</textarea>
                    ...
                    @endif
                    <br>
                    <a href="{{ route('change_password') }}" class="inputLabel text-decoration-none">Change
                        password</a>
